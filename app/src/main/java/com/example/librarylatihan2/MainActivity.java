package com.example.librarylatihan2;
...
public class MainActivity extends AppCompatActivity {
    ...
    private <okListener> void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
...
//            Uri uri = Uri.fromFile(pdfFile);
            Uri uri = FileProvider.getUriForFile(this,  "com.example.librarylatihan2.fileprovider", pdfFile);
